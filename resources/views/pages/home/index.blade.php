...
@section('content')
    <section id="hero" class="bg-blue-dark mx-auto px-20 pt-2">
        @include('pages.home.hero')
    </section>
    <section id="dealerships" class="bg-blue-dark mx-auto px-20 p-10">
        <div class="space-y-2">
    ...
    <section id="best-cars" class="mx-auto px-20 bg-white py-6">
        @include('pages.home.best-cars')
    </section>
    <section id="about" class="bg-blue-dark mx-auto px-20 py-6">
