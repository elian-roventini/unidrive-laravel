...
@php
    $className = 'inline-flex items-center px-4 py-2 bg-orange rounded-md font-semibold text-xs uppercase tracking-widest focus:outline-none focus:border-orange-dark disabled:opacity-25 transition ease-in-out duration-150';
