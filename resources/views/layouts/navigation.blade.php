<nav x-data="{ open: false }">
    ...
    <div :class="{'block': open, 'hidden': !open}" class="hidden md:hidden pb-6">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('home.index')" :active="request()->routeIs('cars.index')">
                {{ __('Carros') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('home.index')" :active="request()->routeIs('about.index')">
                {{ __('Sobre Nós') }}
            </x-responsive-nav-link>
        </div>
