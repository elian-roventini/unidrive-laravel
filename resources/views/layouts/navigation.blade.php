<nav x-data="{ open: false }" class="">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 md:flex">
                    ...
                    <x-nav-link :href="route('index')" :active="request()->routeIs('cars')">
                        {{ __('Carros') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': !open}" class="hidden md:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('index')" :active="request()->routeIs('cars')">
                {{ __('Carros') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('index')" :active="request()->routeIs('about')">
                {{ __('Sobre Nós') }}
            </x-responsive-nav-link>
        </div>
