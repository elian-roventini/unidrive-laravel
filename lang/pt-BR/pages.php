...
return [
    'home' => [
        ...
        'dealerships' => [
            ...
            'subtitle' => 'Algumas das concessionárias que trabalhamos!'
        ],
        'best-cars' => [
            'title' => 'Veículos em alta',
            'subtitle' => 'Os veículos mais procurados disponiveis para você!',
            'not_found' => 'Não existem carros cadastrados',
            'button' => 'Ver Mais',
        ],
        'about' => [
            'title' => 'Quem somos?',
